...
public class ExportvoucherListCsvFilter : IEquatable<ExportvoucherListCsvFilter>, IValidatableObject
{
	...
	public bool Equals(ExportvoucherListCsvFilter? input)
	{
		...
		return
			...
			(
				StartPayDate == input.StartPayDate ||
				(StartPayDate != null &&
				 StartPayDate.Equals(input.StartPayDate))
			) &&
			(
				EndPayDate == input.EndPayDate ||
				(EndPayDate != null &&
				 EndPayDate.Equals(input.EndPayDate))
			) &&
			(
			...
			(
				...
				(StartAmount != null &&
				 StartAmount.Equals(input.StartAmount))
			) &&
			(
				EndAmount == input.EndAmount ||
				(EndAmount != null &&
				 EndAmount.Equals(input.EndAmount))
			);
	}
	...
	public override string ToString()
	{
		...
		sb.Append("  StartPayDate: ").Append(StartPayDate).Append('\n');
		sb.Append("  EndPayDate: ").Append(EndPayDate).Append('\n');
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			{
				hashCode = hashCode * 59 + StartPayDate.GetHashCode();
			}

			if (EndPayDate != null)
			{
				hashCode = hashCode * 59 + EndPayDate.GetHashCode();
			}
			...
			if (StartAmount != null)
			{
				hashCode = hashCode * 59 + StartAmount.GetHashCode();
			}

			if (EndAmount != null)
			{
				hashCode = hashCode * 59 + EndAmount.GetHashCode();
			}
