...
public class SaveCreditNote : IEquatable<SaveCreditNote>, IValidatableObject
{
		...
		SaveInvoiceDiscountSave discountSave = default, SaveCreditNoteDiscountDelete discountDelete = default)
	{
		...
		if (creditNote == null)
		{
			throw new InvalidDataException("creditNote is a required property for SaveCreditNote and cannot be null");
		}

		CreditNote = creditNote;
		CreditNotePosSave = creditNotePosSave;
		CreditNotePosDelete = creditNotePosDelete;
		Filename = filename;
	...
	public bool Equals(SaveCreditNote? input)
	{
		...
		return
			...
			(
				CreditNotePosSave == input.CreditNotePosSave ||
				(CreditNotePosSave != null &&
				 CreditNotePosSave.Equals(input.CreditNotePosSave))
			) &&
			(
				CreditNotePosDelete == input.CreditNotePosDelete ||
				(CreditNotePosDelete != null &&
				 CreditNotePosDelete.Equals(input.CreditNotePosDelete))
			) &&
			(
			...
			(
				DiscountSave == input.DiscountSave ||
				(DiscountSave != null &&
				 DiscountSave.Equals(input.DiscountSave))
			) &&
			(
				DiscountDelete == input.DiscountDelete ||
				(DiscountDelete != null &&
				 DiscountDelete.Equals(input.DiscountDelete))
			);
	}
	...
	public override string ToString()
	{
		...
		sb.Append("  CreditNotePosSave: ").Append(CreditNotePosSave).Append('\n');
		sb.Append("  CreditNotePosDelete: ").Append(CreditNotePosDelete).Append('\n');
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (CreditNotePosSave != null)
			{
				hashCode = hashCode * 59 + CreditNotePosSave.GetHashCode();
			}

			if (CreditNotePosDelete != null)
			{
				hashCode = hashCode * 59 + CreditNotePosDelete.GetHashCode();
			}
			...
			{
				hashCode = hashCode * 59 + DiscountSave.GetHashCode();
			}

			if (DiscountDelete != null)
			{
				hashCode = hashCode * 59 + DiscountDelete.GetHashCode();
			}
