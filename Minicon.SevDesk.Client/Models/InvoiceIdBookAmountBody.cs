		...
		InvoiceinvoiceIdbookAmountCheckAccountTransaction checkAccountTransaction = default, bool? createFeed = default)
	{
		...
		if (amount == null)
		{
			throw new InvalidDataException(
				"amount is a required property for InvoiceIdBookAmountBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"date is a required property for InvoiceIdBookAmountBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"type is a required property for InvoiceIdBookAmountBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"checkAccount is a required property for InvoiceIdBookAmountBody and cannot be null");
		}
