...
public class GetOrderPositionsByIdResponse : IEquatable<GetOrderPositionsByIdResponse>, IValidatableObject
{
	...
	public GetOrderPositionsByIdResponse(List<ModelOrderPosResponse> objects = default)
	{
		Objects = objects;
	}
	...
	public List<ModelOrderPosResponse> Objects { get; set; }

	/// <summary>
	///     Returns true if GetOrderPositionsByIdResponse instances are equal
	/// </summary>
	...
	{
		return Equals(input as GetOrderPositionsByIdResponse);
	}
