...
public class SaveOrder : IEquatable<SaveOrder>, IValidatableObject
{
		...
		SaveOrderOrderPosDelete orderPosDelete = default)
	{
		...
		if (order == null)
		{
			throw new InvalidDataException("order is a required property for SaveOrder and cannot be null");
		}
	...
	public bool Equals(SaveOrder? input)
	{
		...
		return
			...
			(
				OrderPosSave == input.OrderPosSave ||
				(OrderPosSave != null &&
				 OrderPosSave.Equals(input.OrderPosSave))
			) &&
			(
				OrderPosDelete == input.OrderPosDelete ||
				(OrderPosDelete != null &&
				 OrderPosDelete.Equals(input.OrderPosDelete))
			);
	}
	...
	public override string ToString()
	{
		...
		sb.Append("  OrderPosSave: ").Append(OrderPosSave).Append('\n');
		sb.Append("  OrderPosDelete: ").Append(OrderPosDelete).Append('\n');
		sb.Append("}\n");
		return sb.ToString();
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (OrderPosSave != null)
			{
				hashCode = hashCode * 59 + OrderPosSave.GetHashCode();
			}

			if (OrderPosDelete != null)
			{
				hashCode = hashCode * 59 + OrderPosDelete.GetHashCode();
			}
