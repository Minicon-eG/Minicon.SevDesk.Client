...
/// <summary>
///     ReportInvoiceRequest
/// </summary>
[DataContract]
public class ReportInvoiceRequest : IEquatable<ReportInvoiceRequest>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ReportInvoiceRequest" /> class.
	/// </summary>
	...
	public ReportInvoiceRequest(int? limit = default, object modelName = default, object objectName = default,
		ExportinvoiceCsvFilter filter = default)
	{
		...
		if (modelName == null)
		{
			throw new InvalidDataException(
				"modelName is a required property for ReportInvoiceRequest and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for ReportInvoiceRequest and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ReportInvoiceRequest instances are equal
	/// </summary>
	/// <param name="input">Instance of ReportInvoiceRequest to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ReportInvoiceRequest input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ReportInvoiceRequest {\n");
	...
	{
		return Equals(input as ReportInvoiceRequest);
	}
