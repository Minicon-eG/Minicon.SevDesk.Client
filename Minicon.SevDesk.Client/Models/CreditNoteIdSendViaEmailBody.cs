...
/// </summary>
[DataContract]
public class CreditNoteIdSendViaEmailBody : IEquatable<CreditNoteIdSendViaEmailBody>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="CreditNoteIdSendViaEmailBody" /> class.
	/// </summary>
	...
	public CreditNoteIdSendViaEmailBody(string toEmail = default, string subject = default, string text = default,
		...
		string bccEmail = default)
	{
		...
		if (toEmail == null)
		{
			throw new InvalidDataException(
				"toEmail is a required property for CreditNoteIdSendViaEmailBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"subject is a required property for CreditNoteIdSendViaEmailBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"text is a required property for CreditNoteIdSendViaEmailBody and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if CreditNoteIdSendViaEmailBody instances are equal
	/// </summary>
	...
	{
		return Equals(input as CreditNoteIdSendViaEmailBody);
	}
