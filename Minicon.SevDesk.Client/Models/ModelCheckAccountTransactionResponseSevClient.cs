...
/// </summary>
[DataContract]
public class ModelCheckAccountTransactionResponseSevClient : IEquatable<ModelCheckAccountTransactionResponseSevClient>,
	IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelCheckAccountTransactionResponseSevClient" /> class.
	/// </summary>
	...
	public ModelCheckAccountTransactionResponseSevClient(string id = default, string objectName = default)
	{
		// to ensure "id" is required (not null)
		if (id == null)
		{
			throw new InvalidDataException(
				"id is a required property for ModelCheckAccountTransactionResponseSevClient and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for ModelCheckAccountTransactionResponseSevClient and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ModelCheckAccountTransactionResponseSevClient instances are equal
	/// </summary>
	...
	{
		return Equals(input as ModelCheckAccountTransactionResponseSevClient);
	}
