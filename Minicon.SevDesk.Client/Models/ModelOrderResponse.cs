...
/// </summary>
[DataContract]
public class ModelOrderResponse : Pageable, IEquatable<ModelOrderResponse>, IValidatableObject
{
	/// <summary>
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelOrderResponse" /> class.
	/// </summary>
	...
	///     *     API-Overview to understand how this attribute can be used before using it!.
	/// </param>
	public ModelOrderResponse(string orderNumber = default, ModelOrderResponseContact contact = default,
		DateTime? orderDate = default, StatusEnum? status = default, string header = default, string headText = default,
		string footText = default, ModelOrderResponseAddressCountry addressCountry = default,
		ModelInvoiceResponseCreateUser createUser = default, ModelOrderResponseSevClient sevClient = default,
		string deliveryTerms = default, string paymentTerms = default, ModelOrderResponseOrigin origin = default,
		string version = default, bool? smallSettlement = default,
		ModelOrderResponseContactPerson contactPerson = default, string taxRate = default,
		ModelOrderResponseTaxSet taxSet = default, string taxText = default, string taxType = default,
		OrderTypeEnum? orderType = default, DateTime? sendDate = default, string address = default,
	...
	public ModelOrderResponseContact Contact { get; set; }
	...
	public ModelOrderResponseAddressCountry AddressCountry { get; set; }
	...
	public ModelOrderResponseSevClient SevClient { get; set; }
	...
	public ModelOrderResponseOrigin Origin { get; set; }
	...
	public ModelOrderResponseContactPerson ContactPerson { get; set; }
	...
	public ModelOrderResponseTaxSet TaxSet { get; set; }
	...
	/// <summary>
	///     Returns true if ModelOrderResponse instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelOrderResponse to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelOrderResponse? input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ModelOrderResponse {\n");
	...
	{
		return Equals(input as ModelOrderResponse);
	}
