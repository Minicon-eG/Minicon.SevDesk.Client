...
/// </summary>
[DataContract]
public class SevQuery3 : IEquatable<SevQuery3>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="SevQuery3" /> class.
	/// </summary>
	...
	public SevQuery3(int? limit = default, object modelName = default, object objectName = default,
		ReportorderlistFilter filter = default)
	{
		// to ensure "modelName" is required (not null)
		if (modelName == null)
		{
			throw new InvalidDataException("modelName is a required property for SevQuery3 and cannot be null");
		}
		...
		if (objectName == null)
		{
			throw new InvalidDataException("objectName is a required property for SevQuery3 and cannot be null");
		}
	...
	public ReportorderlistFilter Filter { get; set; }

	/// <summary>
	///     Returns true if SevQuery3 instances are equal
	/// </summary>
	/// <param name="input">Instance of SevQuery3 to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(SevQuery3 input)
	{
		if (input == null)
		{
			return false;
	...
	{
		return Equals(input as SevQuery3);
	}
