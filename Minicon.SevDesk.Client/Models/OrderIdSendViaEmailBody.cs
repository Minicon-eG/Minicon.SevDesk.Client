		...
		string bccEmail = default)
	{
		...
		if (toEmail == null)
		{
			throw new InvalidDataException(
				"toEmail is a required property for OrderIdSendViaEmailBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"subject is a required property for OrderIdSendViaEmailBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"text is a required property for OrderIdSendViaEmailBody and cannot be null");
		}
