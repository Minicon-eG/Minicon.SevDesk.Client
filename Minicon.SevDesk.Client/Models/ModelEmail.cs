...
/// </summary>
[DataContract]
public class ModelEmail : IEquatable<ModelEmail>, IValidatableObject
{
	/// <summary>
	...
	public ModelEmail(ModelEmailOrderObject _object = default, string from = default, string to = default,
		...
		string cc = default, string bcc = default, DateTime? arrived = default)
	{
		...
		if (from == null)
		{
			throw new InvalidDataException("from is a required property for ModelEmail and cannot be null");
		}
		...
		if (to == null)
		{
			throw new InvalidDataException("to is a required property for ModelEmail and cannot be null");
		}
		...
		if (subject == null)
		{
			throw new InvalidDataException("subject is a required property for ModelEmail and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ModelEmail instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelEmail to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelEmail input)
	{
		if (input == null)
		{
			return false;
		...
		return
			...
			(
				Bcc == input.Bcc ||
				(Bcc != null &&
				 Bcc.Equals(input.Bcc))
			) &&
			(
				Arrived == input.Arrived ||
				(Arrived != null &&
				 Arrived.Equals(input.Arrived))
			);
	}
	...
	{
		return Equals(input as ModelEmail);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (Arrived != null)
			{
				hashCode = hashCode * 59 + Arrived.GetHashCode();
			}
