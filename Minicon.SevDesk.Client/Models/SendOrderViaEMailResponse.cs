...
public class SendOrderViaEMailResponse : IEquatable<SendOrderViaEMailResponse>, IValidatableObject
{
	...
	public SendOrderViaEMailResponse(List<ModelEmailOrder> objects = default)
	{
		Objects = objects;
	}
	...
	/// <summary>
	///     Returns true if SendOrderViaEMailResponse instances are equal
	/// </summary>
	...
	{
		return Equals(input as SendOrderViaEMailResponse);
	}
