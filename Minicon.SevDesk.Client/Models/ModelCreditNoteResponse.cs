...
/// </summary>
[DataContract]
public class ModelCreditNoteResponse : Pageable, IEquatable<ModelCreditNoteResponse>, IValidatableObject
{
	/// <summary>
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelCreditNoteResponse" /> class.
	/// </summary>
	...
	/// </param>
	public ModelCreditNoteResponse(string creditNoteNumber = default, ModelCreditNoteResponseContact contact = default,
		DateTime? creditNoteDate = default, StatusEnum? status = default, string header = default,
		string headText = default, string footText = default,
		ModelCreditNoteResponseAddressCountry addressCountry = default,
		ModelInvoiceResponseCreateUser createUser = default, ModelCreditNoteResponseSevClient sevClient = default,
		...
		ModelCreditNoteResponseContactPerson contactPerson = default, string taxRate = default,
		ModelCreditNoteResponseTaxSet taxSet = default, string taxText = default, string taxType = default,
	...
	public ModelCreditNoteResponseContact Contact { get; set; }
	...
	public ModelCreditNoteResponseAddressCountry AddressCountry { get; set; }
	...
	public ModelCreditNoteResponseSevClient SevClient { get; set; }
	...
	public ModelCreditNoteResponseContactPerson ContactPerson { get; set; }
	...
	public ModelCreditNoteResponseTaxSet TaxSet { get; set; }
	...
	/// <summary>
	///     Returns true if ModelCreditNoteResponse instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelCreditNoteResponse to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelCreditNoteResponse? input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ModelCreditNoteResponse {\n");
	...
	{
		return Equals(input as ModelCreditNoteResponse);
	}
