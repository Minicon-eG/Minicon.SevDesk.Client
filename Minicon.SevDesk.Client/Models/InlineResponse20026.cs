...
/// </summary>
[DataContract]
public class InlineResponse20026 : IEquatable<InlineResponse20026>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="InlineResponse20026" /> class.
	/// </summary>
	/// <param name="objects">Stock amount.</param>
	public InlineResponse20026(int? objects = default)
	{
		Objects = objects;
	}
	...
	{
		return Equals(input as InlineResponse20026);
	}
