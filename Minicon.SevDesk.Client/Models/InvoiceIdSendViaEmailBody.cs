...
/// </summary>
[DataContract]
public class InvoiceIdSendViaEmailBody : IEquatable<InvoiceIdSendViaEmailBody>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="InvoiceIdSendViaEmailBody" /> class.
	/// </summary>
	...
	public InvoiceIdSendViaEmailBody(string toEmail = default, string subject = default, string text = default,
		...
		string bccEmail = default)
	{
		...
		if (toEmail == null)
		{
			throw new InvalidDataException(
				"toEmail is a required property for InvoiceIdSendViaEmailBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"subject is a required property for InvoiceIdSendViaEmailBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"text is a required property for InvoiceIdSendViaEmailBody and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if InvoiceIdSendViaEmailBody instances are equal
	/// </summary>
	/// <param name="input">Instance of InvoiceIdSendViaEmailBody to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(InvoiceIdSendViaEmailBody input)
	{
		if (input == null)
		{
			return false;
		...
		return
			...
			(
				Copy == input.Copy ||
				(Copy != null &&
				 Copy.Equals(input.Copy))
			) &&
			(
				AdditionalAttachments == input.AdditionalAttachments ||
				(AdditionalAttachments != null &&
				 AdditionalAttachments.Equals(input.AdditionalAttachments))
			) &&
			(
			...
			(
				...
				(BccEmail != null &&
				 BccEmail.Equals(input.BccEmail))
			);
	}
	...
	public override string ToString()
	{
		...
		sb.Append("class InvoiceIdSendViaEmailBody {\n");
	...
	{
		return Equals(input as InvoiceIdSendViaEmailBody);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			{
				hashCode = hashCode * 59 + AdditionalAttachments.GetHashCode();
			}

			if (CcEmail != null)
			{
				hashCode = hashCode * 59 + CcEmail.GetHashCode();
			}

			if (BccEmail != null)
			{
				hashCode = hashCode * 59 + BccEmail.GetHashCode();
			}
