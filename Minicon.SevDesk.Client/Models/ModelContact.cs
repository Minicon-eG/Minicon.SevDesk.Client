...
/// </summary>
[DataContract]
public class ModelContact : IEquatable<ModelContact>, IValidatableObject
{
	/// <summary>
	...
	public ModelContact(string name = default, int? status = 100, string customerNumber = default,
		ModelContactParent parent = default, string surename = default, string familyname = default,
		string titel = default, ModelContactCategory category = default, string description = default,
		...
		bool? defaultDiscountPercentage = default, string buyerReference = default, bool? governmentAgency = default)
	{
		...
		if (category == null)
		{
			throw new InvalidDataException("category is a required property for ModelContact and cannot be null");
		}
	...
	public ModelContactParent Parent { get; set; }
	...
	public ModelContactCategory Category { get; set; }
	...
	{
		return Equals(input as ModelContact);
	}
