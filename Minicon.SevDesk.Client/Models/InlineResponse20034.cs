...
/// </summary>
[DataContract]
public class InlineResponse20034 : IEquatable<InlineResponse20034>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="InlineResponse20034" /> class.
	/// </summary>
	/// <param name="objects">the count of all references.</param>
	public InlineResponse20034(int? objects = default)
	{
		Objects = objects;
	}
	...
	{
		return Equals(input as InlineResponse20034);
	}
