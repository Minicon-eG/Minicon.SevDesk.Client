...
/// </summary>
[DataContract]
public class VoucherIdBookAmountBody : IEquatable<VoucherIdBookAmountBody>, IValidatableObject
{
	/// <summary>
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="VoucherIdBookAmountBody" /> class.
	/// </summary>
	...
	public VoucherIdBookAmountBody(decimal? amount = default, DateTime? date = default, TypeEnum type = default,
		VouchervoucherIdbookAmountCheckAccount checkAccount = default,
		VouchervoucherIdbookAmountCheckAccountTransaction checkAccountTransaction = default, bool? createFeed = default)
	{
		// to ensure "amount" is required (not null)
		if (amount == null)
		{
			throw new InvalidDataException(
				"amount is a required property for VoucherIdBookAmountBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"date is a required property for VoucherIdBookAmountBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"type is a required property for VoucherIdBookAmountBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"checkAccount is a required property for VoucherIdBookAmountBody and cannot be null");
		}
	...
	public VouchervoucherIdbookAmountCheckAccountTransaction CheckAccountTransaction { get; set; }
	...
	/// <summary>
	///     Returns true if VoucherIdBookAmountBody instances are equal
	/// </summary>
	...
	{
		return Equals(input as VoucherIdBookAmountBody);
	}
