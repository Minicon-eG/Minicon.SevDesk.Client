...
public class ModelOrderPosSevClient : IEquatable<ModelOrderPosSevClient>, IValidatableObject
{
	...
	public ModelOrderPosSevClient(int? id = default, string objectName = default)
	{
		...
		if (id == null)
		{
			throw new InvalidDataException("id is a required property for ModelOrderPosSevClient and cannot be null");
		}
		...
		if (objectName == null)
		{
			throw new InvalidDataException(
				"objectName is a required property for ModelOrderPosSevClient and cannot be null");
		}
