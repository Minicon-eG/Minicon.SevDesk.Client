...
public class GetRelatedObjectsResponse : IEquatable<GetRelatedObjectsResponse>, IValidatableObject
{
	...
	public GetRelatedObjectsResponse(object objects = default)
	{
		Objects = objects;
	}
	...
	/// <summary>
	///     Returns true if GetRelatedObjectsResponse instances are equal
	/// </summary>
	...
	{
		return Equals(input as GetRelatedObjectsResponse);
	}
