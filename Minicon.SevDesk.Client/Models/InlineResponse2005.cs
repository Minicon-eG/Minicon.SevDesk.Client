...
/// </summary>
[DataContract]
public class InlineResponse2005 : IEquatable<InlineResponse2005>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="InlineResponse2005" /> class.
	/// </summary>
	/// <param name="objects">objects.</param>
	public InlineResponse2005(List<ModelCreditNoteResponse> objects = default)
	{
		Objects = objects;
	}
	...
	{
		return Equals(input as InlineResponse2005);
	}
