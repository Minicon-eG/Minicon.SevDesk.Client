		...
		decimal? value = default, string objectName = default, bool? mapAll = default)
	{
		...
		if (discount == null)
		{
			throw new InvalidDataException(
				"discount is a required property for SaveInvoiceDiscountSave and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"text is a required property for SaveInvoiceDiscountSave and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"percentage is a required property for SaveInvoiceDiscountSave and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"value is a required property for SaveInvoiceDiscountSave and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for SaveInvoiceDiscountSave and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"mapAll is a required property for SaveInvoiceDiscountSave and cannot be null");
		}
