...
/// </summary>
[DataContract]
public class ModelContactAddress : IEquatable<ModelContactAddress>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelContactAddress" /> class.
	/// </summary>
	...
	public ModelContactAddress(ModelContactAddressContact contact = default, string street = default,
		...
		string name4 = default)
	{
		...
		if (contact == null)
		{
			throw new InvalidDataException("contact is a required property for ModelContactAddress and cannot be null");
		}
		...
		if (country == null)
		{
			throw new InvalidDataException("country is a required property for ModelContactAddress and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ModelContactAddress instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelContactAddress to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelContactAddress? input)
	{
		if (input == null)
		{
			return false;
	...
	{
		return Equals(input as ModelContactAddress);
	}
