...
public class ModelVoucherPosVoucher : IEquatable<ModelVoucherPosVoucher>, IValidatableObject
{
	...
	public ModelVoucherPosVoucher(int? id = default)
	{
		...
		if (id == null)
		{
			throw new InvalidDataException("id is a required property for ModelVoucherPosVoucher and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ModelVoucherPosVoucher instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelVoucherPosVoucher to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelVoucherPosVoucher? input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ModelVoucherPosVoucher {\n");
	...
	{
		return Equals(input as ModelVoucherPosVoucher);
	}
