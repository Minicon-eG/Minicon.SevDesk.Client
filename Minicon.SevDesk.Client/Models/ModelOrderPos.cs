...
/// </summary>
[DataContract]
public class ModelOrderPos : IEquatable<ModelOrderPos>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelOrderPos" /> class.
	/// </summary>
	...
	public ModelOrderPos(ModelOrderPosOrder order = default, ModelInvoicePosPart part = default,
		decimal? quantity = default, decimal? price = default, decimal? priceTax = default,
		decimal? priceGross = default, decimal? name = default, ModelCreditNotePosUnity unity = default,
		ModelOrderPosSevClient sevClient = default, int? positionNumber = default, string text = default,
		decimal? discount = default, bool? optional = default, decimal? taxRate = default)
	{
		// to ensure "quantity" is required (not null)
		if (quantity == null)
		{
			throw new InvalidDataException("quantity is a required property for ModelOrderPos and cannot be null");
		}
		...
		if (unity == null)
		{
			throw new InvalidDataException("unity is a required property for ModelOrderPos and cannot be null");
		}
		...
		if (taxRate == null)
		{
			throw new InvalidDataException("taxRate is a required property for ModelOrderPos and cannot be null");
		}
	...
	/// </summary>
	/// <value>The order position id</value>
	...
	/// </summary>
	/// <value>The order position object name</value>
	...
	/// </summary>
	/// <value>Date of order position creation</value>
	...
	/// </summary>
	/// <value>Date of last order position update</value>
	...
	public ModelOrderPosOrder Order { get; set; }
	...
	public ModelOrderPosSevClient SevClient { get; set; }
	...
	/// <summary>
	///     Returns true if ModelOrderPos instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelOrderPos to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelOrderPos? input)
	{
		if (input == null)
		{
			return false;
	...
	{
		return Equals(input as ModelOrderPos);
	}
