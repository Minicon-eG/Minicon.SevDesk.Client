	...
	public InvoiceinvoiceIdbookAmountCheckAccountTransaction(int? id = default, string objectName = default)
	{
		...
		if (id == null)
		{
			throw new InvalidDataException(
				"id is a required property for InvoiceinvoiceIdbookAmountCheckAccountTransaction and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for InvoiceinvoiceIdbookAmountCheckAccountTransaction and cannot be null");
		}
