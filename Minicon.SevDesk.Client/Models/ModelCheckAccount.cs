...
/// </summary>
[DataContract]
public class ModelCheckAccount : IEquatable<ModelCheckAccount>, IValidatableObject
{
	/// <summary>
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelCheckAccount" /> class.
	/// </summary>
	/// <param name="sevClient">sevClient.</param>
	/// <param name="name">Name of the check account (required).</param>
	/// <param name="type">
	...
	///     connection       to a bank application can not be managed over the API. (required).
	/// </param>
	/// <param name="importType">Import type. Transactions can be imported by this method on the check account..</param>
	/// <param name="currency">The currency of the check account. (required).</param>
	...
	/// </param>
	public ModelCheckAccount(ModelCheckAccountSevClient sevClient = default, string name = default,
		...
		int? autoMapTransactions = 1)
	{
		...
		if (name == null)
		{
			throw new InvalidDataException("name is a required property for ModelCheckAccount and cannot be null");
		}
		...
		if (type == null)
		{
			throw new InvalidDataException("type is a required property for ModelCheckAccount and cannot be null");
		}
		...
		if (currency == null)
		{
			throw new InvalidDataException("currency is a required property for ModelCheckAccount and cannot be null");
		}
		...
		if (status == null)
		{
			throw new InvalidDataException("status is a required property for ModelCheckAccount and cannot be null");
		}

		Status = status;
		SevClient = sevClient;
		ImportType = importType;
		// use default value if no "defaultAccount" provided
		if (defaultAccount == null)
		{
			DefaultAccount = DefaultAccountEnum.NUMBER_0;
		}
		else
		{
		...
		// use default value if no "autoMapTransactions" provided
		if (autoMapTransactions == null)
		{
	...
	/// </summary>
	/// <value>The check account id</value>
	...
	/// </summary>
	/// <value>The check account object name</value>
	...
	/// </summary>
	/// <value>Date of check account creation</value>
	...
	/// </summary>
	/// <value>Date of last check account update</value>
	...
	public ModelCheckAccountSevClient SevClient { get; set; }
	...
	/// </summary>
	/// <value>Bank server of check account</value>
	...
	/// <summary>
	///     Returns true if ModelCheckAccount instances are equal
	/// </summary>
	...
	public bool Equals(ModelCheckAccount? input)
	{
		...
		return
			...
			(
				...
				(ImportType != null &&
				 ImportType.Equals(input.ImportType))
			) &&
			(
			...
			(
				...
				(DefaultAccount != null &&
				 DefaultAccount.Equals(input.DefaultAccount))
			) &&
			(
				Status == input.Status ||
				(Status != null &&
			...
			(
				BankServer == input.BankServer ||
				(BankServer != null &&
				 BankServer.Equals(input.BankServer))
			) &&
			(
				AutoMapTransactions == input.AutoMapTransactions ||
				(AutoMapTransactions != null &&
				 AutoMapTransactions.Equals(input.AutoMapTransactions))
			);
	}
	...
	{
		return Equals(input as ModelCheckAccount);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (DefaultAccount != null)
			{
				hashCode = hashCode * 59 + DefaultAccount.GetHashCode();
			}
			...
			if (BankServer != null)
			{
				hashCode = hashCode * 59 + BankServer.GetHashCode();
			}

			if (AutoMapTransactions != null)
			{
				hashCode = hashCode * 59 + AutoMapTransactions.GetHashCode();
			}
