...
/// </summary>
[DataContract]
public class InlineResponse20015Letterpapers : IEquatable<InlineResponse20015Letterpapers>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="InlineResponse20015Letterpapers" /> class.
	/// </summary>
	...
	public InlineResponse20015Letterpapers(string id = default, string pdf = default, string sevClient = default,
		string name = default, int? _default = default, string img = default)
	{
		Id = id;
		Pdf = pdf;
		SevClient = sevClient;
	...
	/// <summary>
	///     Returns true if InlineResponse20015Letterpapers instances are equal
	/// </summary>
	...
	public bool Equals(InlineResponse20015Letterpapers input)
	{
		...
		return
			...
			(
				...
				(_Default != null &&
				 _Default.Equals(input._Default))
			) &&
			(
				Img == input.Img ||
				(Img != null &&
				 Img.Equals(input.Img))
			);
	}
	...
	{
		return Equals(input as InlineResponse20015Letterpapers);
	}
