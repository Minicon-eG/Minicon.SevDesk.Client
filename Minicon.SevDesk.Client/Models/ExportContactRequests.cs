...
/// </summary>
[DataContract]
public class ExportContactRequests : IEquatable<ExportContactRequests>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ExportContactRequests" /> class.
	/// </summary>
	/// <param name="limit">Limit export.</param>
	/// <param name="modelName">Model name, which is &#x27;Contact&#x27; (required).</param>
	/// <param name="objectName">Model name, which is &#x27;SevQuery&#x27; (required).</param>
	/// <param name="filter">filter.</param>
	public ExportContactRequests(int? limit = default, object modelName = default, object objectName = default,
		ReportcontactlistFilter filter = default)
	{
		// to ensure "modelName" is required (not null)
		if (modelName == null)
		{
			throw new InvalidDataException("modelName is a required property for SevQuery9 and cannot be null");
		}
		...
		if (objectName == null)
		{
			throw new InvalidDataException("objectName is a required property for SevQuery9 and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if SevQuery9 instances are equal
	/// </summary>
	...
	{
		return Equals(input as ExportContactRequests);
	}
