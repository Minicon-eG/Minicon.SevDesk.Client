...
/// </summary>
[DataContract]
public class ModelOrderPosResponse : Pageable, IEquatable<ModelOrderPosResponse>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelOrderPosResponse" /> class.
	/// </summary>
	/// <param name="order">order.</param>
	/// <param name="part">part.</param>
	/// <param name="quantity">Quantity of the article/part.</param>
	...
	/// <param name="taxRate">Tax rate of the position..</param>
	public ModelOrderPosResponse(ModelOrderPosResponseOrder order = default,
		...
		ModelCreditNotePosResponseUnity unity = default, ModelOrderPosResponseSevClient sevClient = default,
	...
	public ModelOrderPosResponseOrder Order { get; set; }
	...
	public ModelOrderPosResponseSevClient SevClient { get; set; }
	...
	/// <summary>
	///     Returns true if ModelOrderPosResponse instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelOrderPosResponse to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelOrderPosResponse? input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ModelOrderPosResponse {\n");
	...
	{
		return Equals(input as ModelOrderPosResponse);
	}
