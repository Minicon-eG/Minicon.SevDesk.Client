...
/// </summary>
[DataContract]
public class CreditNoteIdBookAmountBody : IEquatable<CreditNoteIdBookAmountBody>, IValidatableObject
{
	/// <summary>
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="CreditNoteIdBookAmountBody" /> class.
	/// </summary>
	...
	public CreditNoteIdBookAmountBody(decimal? amount = default, int? date = default, TypeEnum type = default,
		VouchervoucherIdbookAmountCheckAccount checkAccount = default,
		CreditNotecreditNoteIdbookAmountCheckAccountTransaction checkAccountTransaction = default,
		bool? createFeed = default)
	{
		// to ensure "amount" is required (not null)
		if (amount == null)
		{
			throw new InvalidDataException(
				"amount is a required property for CreditNoteIdBookAmountBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"date is a required property for CreditNoteIdBookAmountBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"type is a required property for CreditNoteIdBookAmountBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"checkAccount is a required property for CreditNoteIdBookAmountBody and cannot be null");
		}
	...
	public CreditNotecreditNoteIdbookAmountCheckAccountTransaction CheckAccountTransaction { get; set; }
	...
	/// <summary>
	///     Returns true if CreditNoteIdBookAmountBody instances are equal
	/// </summary>
	/// <param name="input">Instance of CreditNoteIdBookAmountBody to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(CreditNoteIdBookAmountBody input)
	{
		if (input == null)
		{
			return false;
		...
		return
			...
			(
				CheckAccountTransaction == input.CheckAccountTransaction ||
				(CheckAccountTransaction != null &&
				 CheckAccountTransaction.Equals(input.CheckAccountTransaction))
			) &&
			(
				CreateFeed == input.CreateFeed ||
				(CreateFeed != null &&
				 CreateFeed.Equals(input.CreateFeed))
			);
	}
	...
	public override string ToString()
	{
		...
		sb.Append("class CreditNoteIdBookAmountBody {\n");
	...
	{
		return Equals(input as CreditNoteIdBookAmountBody);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			{
				hashCode = hashCode * 59 + CheckAccountTransaction.GetHashCode();
			}

			if (CreateFeed != null)
			{
				hashCode = hashCode * 59 + CreateFeed.GetHashCode();
			}
