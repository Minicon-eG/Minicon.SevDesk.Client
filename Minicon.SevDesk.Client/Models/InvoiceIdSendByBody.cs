...
/// </summary>
[DataContract]
public class InvoiceIdSendByBody : IEquatable<InvoiceIdSendByBody>, IValidatableObject
{
	/// <summary>
	///     Specifies the way in which the invoice was sent to the customer.&lt;br&gt;       Accepts &#x27;VPR&#x27; (print),
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="InvoiceIdSendByBody" /> class.
	/// </summary>
	/// <param name="sendType">
	///     Specifies the way in which the invoice was sent to the customer.&lt;br&gt;       Accepts &#x27;
	///     VPR&#x27; (print), &#x27;VP&#x27; (postal), &#x27;VM&#x27; (mail) and &#x27;VPDF&#x27; (downloaded pfd).
	///     (required).
	/// </param>
	/// <param name="sendDraft">Specify if the should be enshrined after marking it as sent. (required).</param>
	public InvoiceIdSendByBody(SendTypeEnum sendType = default, bool? sendDraft = default)
	{
		// to ensure "sendType" is required (not null)
		if (sendType == null)
		{
			throw new InvalidDataException(
				"sendType is a required property for InvoiceIdSendByBody and cannot be null");
		}

		SendType = sendType;
		// to ensure "sendDraft" is required (not null)
		if (sendDraft == null)
		{
			throw new InvalidDataException(
				"sendDraft is a required property for InvoiceIdSendByBody and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if InvoiceIdSendByBody instances are equal
	/// </summary>
	...
	public bool Equals(InvoiceIdSendByBody? input)
	{
		...
		return
			...
			(
				SendDraft == input.SendDraft ||
				(SendDraft != null &&
				 SendDraft.Equals(input.SendDraft))
			);
	}
	...
	{
		return Equals(input as InvoiceIdSendByBody);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (SendDraft != null)
			{
				hashCode = hashCode * 59 + SendDraft.GetHashCode();
			}
