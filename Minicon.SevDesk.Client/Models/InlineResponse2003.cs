...
/// </summary>
[DataContract]
public class InlineResponse2003 : IEquatable<InlineResponse2003>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="InlineResponse2003" /> class.
	/// </summary>
	/// <param name="objects">objects.</param>
	public InlineResponse2003(List<string> objects = default)
	{
		Objects = objects;
	}
	...
	{
		return Equals(input as InlineResponse2003);
	}
