...
/// <summary>
///     The check account transaction on which should be booked.&lt;br&gt;      The transaction will be linked to the
///     credit note.
/// </summary>
[DataContract]
public class
		...
		IEquatable<CreditNotecreditNoteIdbookAmountCheckAccountTransaction>, IValidatableObject
{
	...
	public CreditNotecreditNoteIdbookAmountCheckAccountTransaction(int? id = default, string objectName = default)
	{
		// to ensure "id" is required (not null)
		if (id == null)
		{
			throw new InvalidDataException(
				"id is a required property for CreditNotecreditNoteIdbookAmountCheckAccountTransaction and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for CreditNotecreditNoteIdbookAmountCheckAccountTransaction and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if CreditNotecreditNoteIdbookAmountCheckAccountTransaction instances are equal
	/// </summary>
	...
	{
		return Equals(input as CreditNotecreditNoteIdbookAmountCheckAccountTransaction);
	}
