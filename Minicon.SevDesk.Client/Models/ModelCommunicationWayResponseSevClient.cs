	...
	public ModelCommunicationWayResponseSevClient(string id = default, string objectName = default)
	{
		...
		if (id == null)
		{
			throw new InvalidDataException(
				"id is a required property for ModelCommunicationWayResponseSevClient and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for ModelCommunicationWayResponseSevClient and cannot be null");
		}
