...
/// </summary>
[DataContract]
public class ModelInvoice : IEquatable<ModelInvoice>, IValidatableObject
{
	/// <summary>
	...
	/// </summary>
	/// <value>Type which was used to send the invoice.</value>
	[JsonConverter(typeof(StringEnumConverter))]
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelInvoice" /> class.
	/// </summary>
	/// <param name="id">
	///     The invoice id. &lt;span style&#x3D;&#x27;color:red&#x27;&gt;Required&lt;/span&gt; if you want to
	///     create or update an invoice position for an existing invoice.
	/// </param>
	/// <param name="objectName">The invoice object name..</param>
	...
	/// <param name="invoiceDate">Needs to be provided as timestamp or dd.mm.yyyy (required).</param>
	...
	///     Please have a look in our       &lt;a href&#x3D;&#x27;
	///     https://api.sevdesk.de/#section/Types-and-status-of-invoices&#x27;&gt;Types and status of invoices&lt;/a&gt;
	///     to see what the different status codes mean (required).
	/// </param>
	/// <param name="smallSettlement">
	///     Defines if the client uses the small settlement scheme.      If yes, the invoice must not
	///     contain any vat.
	/// </param>
	/// <param name="taxRate">Is overwritten by invoice position tax rates (required).</param>
	...
	///     (required).
	/// </param>
	/// <param name="currency">Currency used in the invoice. Needs to be currency code according to ISO-4217 (required).</param>
	/// <param name="showNet">If true, the net amount of each position will be shown on the invoice. Otherwise gross amount.</param>
	/// <param name="sendType">Type which was used to send the invoice..</param>
	...
	public ModelInvoice(int? id = default, string objectName = default, string invoiceNumber = default,
		ModelInvoiceContact contact = default, ModelInvoiceUpdateContactPerson contactPerson = default,
		ModelInvoiceUpdateSevClient sevClient = default, string invoiceDate = default, string header = default,
		string headText = default, string footText = default, int? timeToPay = default, int? discount = default,
		string address = default, ModelInvoiceAddressCountry addressCountry = default, DateTime? payDate = default,
		ModelCreditNoteCreateUser createUser = default, DateTime? deliveryDate = default,
		int? deliveryDateUntil = default, StatusEnum status = default, bool? smallSettlement = default,
		float? taxRate = default, string taxText = default, TaxTypeEnum taxType = default,
		ModelInvoiceTaxSet taxSet = default, ModelInvoicePaymentMethod paymentMethod = default,
		DateTime? sendDate = default, InvoiceTypeEnum invoiceType = default, string currency = default,
		bool? showNet = default, SendTypeEnum? sendType = default, ModelInvoiceOrigin origin = default,
		string customerInternalNote = default, bool? mapAll = default)
	{
		// to ensure "contact" is required (not null)
		if (contact == null)
		{
			throw new InvalidDataException("contact is a required property for ModelInvoice and cannot be null");
		}
		...
		{
			throw new InvalidDataException("contactPerson is a required property for ModelInvoice and cannot be null");
		}
		...
		if (invoiceDate == null)
		{
			throw new InvalidDataException("invoiceDate is a required property for ModelInvoice and cannot be null");
		}
		...
		if (discount == null)
		{
			throw new InvalidDataException("discount is a required property for ModelInvoice and cannot be null");
		}
		...
		{
			throw new InvalidDataException("addressCountry is a required property for ModelInvoice and cannot be null");
		}
		...
		if (status == null)
		{
			throw new InvalidDataException("status is a required property for ModelInvoice and cannot be null");
		}
		...
		if (taxRate == null)
		{
			throw new InvalidDataException("taxRate is a required property for ModelInvoice and cannot be null");
		}
		...
		if (taxText == null)
		{
			throw new InvalidDataException("taxText is a required property for ModelInvoice and cannot be null");
		}
		...
		if (taxType == null)
		{
			throw new InvalidDataException("taxType is a required property for ModelInvoice and cannot be null");
		}
		...
		if (invoiceType == null)
		{
			throw new InvalidDataException("invoiceType is a required property for ModelInvoice and cannot be null");
		}
		...
		if (currency == null)
		{
			throw new InvalidDataException("currency is a required property for ModelInvoice and cannot be null");
		}
		...
		if (mapAll == null)
		{
			throw new InvalidDataException("mapAll is a required property for ModelInvoice and cannot be null");
		}
	...
	/// <summary>
	///     The invoice id. &lt;span style&#x3D;&#x27;color:red&#x27;&gt;Required&lt;/span&gt; if you want to create or update
	///     an invoice position for an existing invoice
	/// </summary>
	/// <value>
	///     The invoice id. &lt;span style&#x3D;&#x27;color:red&#x27;&gt;Required&lt;/span&gt; if you want to create or
	///     update an invoice position for an existing invoice
	/// </value>
	...
	public ModelInvoiceContact Contact { get; set; }
	...
	public ModelInvoiceAddressCountry AddressCountry { get; set; }
	...
	public ModelInvoiceTaxSet TaxSet { get; set; }
	...
	public ModelInvoicePaymentMethod PaymentMethod { get; set; }
	...
	public ModelInvoiceOrigin Origin { get; set; }
	...
	/// <summary>
	///     Returns true if ModelInvoice instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelInvoice to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelInvoice input)
	{
		if (input == null)
		{
			return false;
	...
	{
		return Equals(input as ModelInvoice);
	}
