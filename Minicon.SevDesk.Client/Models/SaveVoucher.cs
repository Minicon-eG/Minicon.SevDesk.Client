...
public class SaveVoucher : IEquatable<SaveVoucher>, IValidatableObject
{
	...
	public bool Equals(SaveVoucher? input)
	{
		...
		return
			...
			(
				VoucherPosSave == input.VoucherPosSave ||
				(VoucherPosSave != null &&
				 VoucherPosSave.Equals(input.VoucherPosSave))
			) &&
			(
				VoucherPosDelete == input.VoucherPosDelete ||
				(VoucherPosDelete != null &&
				 VoucherPosDelete.Equals(input.VoucherPosDelete))
			) &&
			(
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (VoucherPosSave != null)
			{
				hashCode = hashCode * 59 + VoucherPosSave.GetHashCode();
			}

			if (VoucherPosDelete != null)
			{
				hashCode = hashCode * 59 + VoucherPosDelete.GetHashCode();
			}
