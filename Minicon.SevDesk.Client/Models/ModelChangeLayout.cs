...
public class ModelChangeLayout : IEquatable<ModelChangeLayout>, IValidatableObject
{
	...
	public ModelChangeLayout(KeyEnum key = default, string value = default)
	{
		...
		if (key == null)
		{
			throw new InvalidDataException("key is a required property for ModelChangeLayout and cannot be null");
		}
		...
		if (value == null)
		{
			throw new InvalidDataException("value is a required property for ModelChangeLayout and cannot be null");
		}
