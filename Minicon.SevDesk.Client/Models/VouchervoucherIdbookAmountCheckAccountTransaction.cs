		...
		IValidatableObject
{
	...
	public VouchervoucherIdbookAmountCheckAccountTransaction(int? id = default, string objectName = default)
	{
		// to ensure "id" is required (not null)
		if (id == null)
		{
			throw new InvalidDataException(
				"id is a required property for VouchervoucherIdbookAmountCheckAccountTransaction and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for VouchervoucherIdbookAmountCheckAccountTransaction and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if VouchervoucherIdbookAmountCheckAccountTransaction instances are equal
	/// </summary>
	...
	{
		return Equals(input as VouchervoucherIdbookAmountCheckAccountTransaction);
	}
