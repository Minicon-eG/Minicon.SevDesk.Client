...
public class ModelEmailOrder : IEquatable<ModelEmailOrder>, IValidatableObject
{
		...
		string cc = default, string bcc = default, DateTime? arrived = default)
	{
		...
		if (from == null)
		{
			throw new InvalidDataException("from is a required property for ModelEmailOrder and cannot be null");
		}
		...
		if (to == null)
		{
			throw new InvalidDataException("to is a required property for ModelEmailOrder and cannot be null");
		}
		...
		if (subject == null)
		{
			throw new InvalidDataException("subject is a required property for ModelEmailOrder and cannot be null");
		}
