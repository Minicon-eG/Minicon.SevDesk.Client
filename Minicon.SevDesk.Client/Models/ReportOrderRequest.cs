...
/// </summary>
[DataContract]
public class ReportOrderRequest : IEquatable<ReportOrderRequest>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ReportOrderRequest" /> class.
	/// </summary>
	...
	public ReportOrderRequest(int? limit = default, object modelName = default, object objectName = default,
		ReportorderlistFilter filter = default)
	{
		...
		if (modelName == null)
		{
			throw new InvalidDataException(
				"modelName is a required property for ReportOrderRequest and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for ReportOrderRequest and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ReportOrderRequest instances are equal
	/// </summary>
	...
	{
		return Equals(input as ReportOrderRequest);
	}
