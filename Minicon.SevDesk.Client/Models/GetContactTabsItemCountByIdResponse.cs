...
public class GetContactTabsItemCountByIdResponse : IEquatable<GetContactTabsItemCountByIdResponse>, IValidatableObject
{
	...
	public GetContactTabsItemCountByIdResponse(decimal? orders = default, decimal? invoices = default,
		decimal? creditNotes = default,
	...
	public bool Equals(GetContactTabsItemCountByIdResponse input)
	{
		...
		return
			...
			(
				...
				(Persons != null &&
				 Persons.Equals(input.Persons))
			) &&
			(
				Vouchers == input.Vouchers ||
				(Vouchers != null &&
				 Vouchers.Equals(input.Vouchers))
			) &&
			(
				Letters == input.Letters ||
				(Letters != null &&
				 Letters.Equals(input.Letters))
			) &&
			(
				Parts == input.Parts ||
				(Parts != null &&
				 Parts.Equals(input.Parts))
			) &&
			(
				InvoicePos == input.InvoicePos ||
				(InvoicePos != null &&
				 InvoicePos.Equals(input.InvoicePos))
			);
	}
	...
	{
		return Equals(input as GetContactTabsItemCountByIdResponse);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (Vouchers != null)
			{
				hashCode = hashCode * 59 + Vouchers.GetHashCode();
			}

			if (Letters != null)
			{
				hashCode = hashCode * 59 + Letters.GetHashCode();
			}
			...
			if (InvoicePos != null)
			{
				hashCode = hashCode * 59 + InvoicePos.GetHashCode();
			}
