...
/// </summary>
[DataContract]
public class ModelInvoicePosUpdate : IEquatable<ModelInvoicePosUpdate>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelInvoicePosUpdate" /> class.
	/// </summary>
	...
	public ModelInvoicePosUpdate(ModelInvoicePosUpdateInvoice invoice = default, ModelInvoicePosPart part = default,
		float? quantity = default, float? price = default, string name = default, ModelInvoicePosUnity unity = default,
	...
	public ModelInvoicePosUpdateInvoice Invoice { get; set; }
	...
	/// <summary>
	///     Returns true if ModelInvoicePosUpdate instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelInvoicePosUpdate to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelInvoicePosUpdate input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ModelInvoicePosUpdate {\n");
	...
	{
		return Equals(input as ModelInvoicePosUpdate);
	}
