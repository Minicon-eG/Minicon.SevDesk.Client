...
public class TagFactorycreateObject : IEquatable<TagFactorycreateObject>, IValidatableObject
{
	...
	public TagFactorycreateObject(int? id = default, ObjectNameEnum objectName = default)
	{
		...
		if (id == null)
		{
			throw new InvalidDataException("id is a required property for TagFactorycreateObject and cannot be null");
		}
		...
		if (objectName == null)
		{
			throw new InvalidDataException(
				"objectName is a required property for TagFactorycreateObject and cannot be null");
		}
