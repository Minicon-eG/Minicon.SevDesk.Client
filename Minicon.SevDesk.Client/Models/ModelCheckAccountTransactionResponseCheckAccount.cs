	...
	IValidatableObject
{
	...
	public ModelCheckAccountTransactionResponseCheckAccount(string id = default, string objectName = default)
	{
		// to ensure "id" is required (not null)
		if (id == null)
		{
			throw new InvalidDataException(
				"id is a required property for ModelCheckAccountTransactionResponseCheckAccount and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for ModelCheckAccountTransactionResponseCheckAccount and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ModelCheckAccountTransactionResponseCheckAccount instances are equal
	/// </summary>
	...
	{
		return Equals(input as ModelCheckAccountTransactionResponseCheckAccount);
	}
