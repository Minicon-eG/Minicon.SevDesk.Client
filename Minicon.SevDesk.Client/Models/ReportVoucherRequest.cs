...
/// <summary>
///     ReportVoucherRequest
/// </summary>
[DataContract]
public class ReportVoucherRequest : IEquatable<ReportVoucherRequest>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ReportVoucherRequest" /> class.
	/// </summary>
	...
	public ReportVoucherRequest(int? limit = default, object modelName = default, object objectName = default,
		ExportvoucherListCsvFilter filter = default)
	{
		...
		if (modelName == null)
		{
			throw new InvalidDataException(
				"modelName is a required property for ReportVoucherRequest and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for ReportVoucherRequest and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ReportVoucherRequest instances are equal
	/// </summary>
	/// <param name="input">Instance of ReportVoucherRequest to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ReportVoucherRequest input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ReportVoucherRequest {\n");
	...
	{
		return Equals(input as ReportVoucherRequest);
	}
