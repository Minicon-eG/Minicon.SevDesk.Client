...
/// </summary>
[DataContract]
public class ModelPart : IEquatable<ModelPart>, IValidatableObject
{
	/// <summary>
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelPart" /> class.
	/// </summary>
	/// <param name="name">Name of the part (required).</param>
	/// <param name="partNumber">The part number (required).</param>
	/// <param name="text">A text describing the part.</param>
	/// <param name="category">category.</param>
	/// <param name="stock">The stock of the part (required).</param>
	...
	/// <param name="taxRate">Tax rate of the part (required).</param>
	...
	///     orders..
	/// </param>
	public ModelPart(string name = default, string partNumber = default, string text = default,
		...
		StatusEnum? status = default, string internalComment = default)
	{
		// to ensure "name" is required (not null)
		if (name == null)
		{
			throw new InvalidDataException("name is a required property for ModelPart and cannot be null");
		}
		...
		if (partNumber == null)
		{
			throw new InvalidDataException("partNumber is a required property for ModelPart and cannot be null");
		}
		...
		if (stock == null)
		{
			throw new InvalidDataException("stock is a required property for ModelPart and cannot be null");
		}
		...
		if (unity == null)
		{
			throw new InvalidDataException("unity is a required property for ModelPart and cannot be null");
		}
		...
		if (taxRate == null)
		{
			throw new InvalidDataException("taxRate is a required property for ModelPart and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ModelPart instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelPart to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelPart input)
	{
		if (input == null)
		{
			return false;
		...
		return
			...
			(
				...
				(StockEnabled != null &&
				 StockEnabled.Equals(input.StockEnabled))
			) &&
			(
				Unity == input.Unity ||
				(Unity != null &&
			...
			(
				...
				(PricePurchase != null &&
				 PricePurchase.Equals(input.PricePurchase))
			) &&
			(
			...
			(
				...
				(InternalComment != null &&
				 InternalComment.Equals(input.InternalComment))
			);
	}
	...
	public override string ToString()
	{
		...
		sb.Append("  StockEnabled: ").Append(StockEnabled).Append("\n");
	...
	{
		return Equals(input as ModelPart);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			{
				hashCode = hashCode * 59 + StockEnabled.GetHashCode();
			}
			...
			{
				hashCode = hashCode * 59 + PricePurchase.GetHashCode();
			}
			...
			{
				hashCode = hashCode * 59 + InternalComment.GetHashCode();
			}
