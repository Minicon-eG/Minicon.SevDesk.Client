...
public class ModelVoucherPosSevClient : IEquatable<ModelVoucherPosSevClient>, IValidatableObject
{
	...
	public ModelVoucherPosSevClient(int? id = default)
	{
		...
		if (id == null)
		{
			throw new InvalidDataException("id is a required property for ModelVoucherPosSevClient and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if ModelVoucherPosSevClient instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelVoucherPosSevClient to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelVoucherPosSevClient? input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ModelVoucherPosSevClient {\n");
	...
	{
		return Equals(input as ModelVoucherPosSevClient);
	}
