...
public class ModelContactResponse : IEquatable<ModelContactResponse>, IValidatableObject
{
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="ModelContactResponse" /> class.
	/// </summary>
	/// <param name="parent">parent.</param>
	/// <param name="category">category.</param>
	/// <param name="sevClient">sevClient.</param>
	/// <param name="taxSet">taxSet.</param>
	public ModelContactResponse(ModelContactResponseParent parent = default,
		ModelContactResponseCategory category = default, ModelContactResponseSevClient sevClient = default,
		ModelContactResponseTaxSet taxSet = default)
	{
		Parent = parent;
		Category = category;
		SevClient = sevClient;
	...
	/// </summary>
	/// <value>The contact object name</value>
	...
	/// </summary>
	/// <value>Date of contact creation</value>
	...
	/// </summary>
	/// <value>Date of last contact update</value>
	...
	public ModelContactResponseParent Parent { get; set; }
	...
	public ModelContactResponseCategory Category { get; set; }
	...
	public ModelContactResponseTaxSet TaxSet { get; set; }
	...
	/// </summary>
	/// <value>Additional information stored for the contact.</value>
	[DataMember(Name = "additionalInformation", EmitDefaultValue = false)]
	public string AdditionalInformation { get; private set; }

	/// <summary>
	///     Returns true if ModelContactResponse instances are equal
	/// </summary>
	...
	{
		return Equals(input as ModelContactResponse);
	}
