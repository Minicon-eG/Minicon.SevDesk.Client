...
/// </summary>
[DataContract]
public class CreditNoteIdSendByBody : IEquatable<CreditNoteIdSendByBody>, IValidatableObject
{
	/// <summary>
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="CreditNoteIdSendByBody" /> class.
	/// </summary>
	/// <param name="sendType">
	///     Specifies the way in which the credit note was sent to the customer.&lt;br&gt;       Accepts
	...
	public CreditNoteIdSendByBody(SendTypeEnum sendType = default, bool? sendDraft = default)
	{
		// to ensure "sendType" is required (not null)
		if (sendType == null)
		{
			throw new InvalidDataException(
				"sendType is a required property for CreditNoteIdSendByBody and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"sendDraft is a required property for CreditNoteIdSendByBody and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if CreditNoteIdSendByBody instances are equal
	/// </summary>
	...
	{
		return Equals(input as CreditNoteIdSendByBody);
	}
