...
/// </summary>
[DataContract]
public class SevQuery9 : IEquatable<SevQuery9>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="SevQuery9" /> class.
	/// </summary>
	...
	public SevQuery9(int? limit = default, object modelName = default, object objectName = default,
	...
	public bool Equals(SevQuery9 input)
	{
		if (input == null)
		{
			return false;
	...
	{
		return Equals(input as SevQuery9);
	}
