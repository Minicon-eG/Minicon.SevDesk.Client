...
public class Base64EncodedFileResponse : IEquatable<Base64EncodedFileResponse>, IValidatableObject
{
	...
	public Base64EncodedFileResponse(
	...
	public bool Equals(Base64EncodedFileResponse input)
	{
		...
		return
			...
			(
				...
				(Base64encoded != null &&
				 Base64encoded.Equals(input.Base64encoded))
			);
	}
	...
	{
		return Equals(input as Base64EncodedFileResponse);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			{
				hashCode = hashCode * 59 + Base64encoded.GetHashCode();
			}
