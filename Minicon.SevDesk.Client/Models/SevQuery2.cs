...
/// </summary>
[DataContract]
public class SevQuery2 : IEquatable<SevQuery2>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="SevQuery2" /> class.
	/// </summary>
	...
	public SevQuery2(int? limit = default, object modelName = default, object objectName = default,
		ExportinvoiceCsvFilter filter = default)
	{
		// to ensure "modelName" is required (not null)
		if (modelName == null)
		{
			throw new InvalidDataException("modelName is a required property for SevQuery2 and cannot be null");
		}
		...
		if (objectName == null)
		{
			throw new InvalidDataException("objectName is a required property for SevQuery2 and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if SevQuery2 instances are equal
	/// </summary>
	/// <param name="input">Instance of SevQuery2 to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(SevQuery2 input)
	{
		if (input == null)
		{
			return false;
	...
	{
		return Equals(input as SevQuery2);
	}
