...
public class OrderIdSendByBody : IEquatable<OrderIdSendByBody>, IValidatableObject
{
	...
	public OrderIdSendByBody(SendTypeEnum sendType = default, bool? sendDraft = default)
	{
		...
		if (sendType == null)
		{
			throw new InvalidDataException("sendType is a required property for OrderIdSendByBody and cannot be null");
		}
		...
		if (sendDraft == null)
		{
			throw new InvalidDataException("sendDraft is a required property for OrderIdSendByBody and cannot be null");
		}
