	...
	IValidatableObject
{
	...
	/// <summary>
	///     Returns true if ModelVoucherPosEstimatedAccountingType instances are equal
	/// </summary>
	/// <param name="input">Instance of ModelVoucherPosEstimatedAccountingType to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ModelVoucherPosEstimatedAccountingType? input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ModelVoucherPosEstimatedAccountingType {\n");
	...
	{
		return Equals(input as ModelVoucherPosEstimatedAccountingType);
	}
