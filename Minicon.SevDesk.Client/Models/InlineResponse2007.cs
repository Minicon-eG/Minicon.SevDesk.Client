...
/// </summary>
[DataContract]
public class InlineResponse2007 : IEquatable<InlineResponse2007>, IValidatableObject
{
	/// <summary>
	///     Initializes a new instance of the <see cref="InlineResponse2007" /> class.
	/// </summary>
	/// <param name="objects">objects.</param>
	public InlineResponse2007(List<ModelOrderPosResponse> objects = default)
	{
		Objects = objects;
	}
	...
	{
		return Equals(input as InlineResponse2007);
	}
