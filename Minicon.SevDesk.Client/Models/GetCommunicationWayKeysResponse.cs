...
public class GetCommunicationWayKeysResponse : Pageable, IEquatable<GetCommunicationWayKeysResponse>, IValidatableObject
{
	...
	/// <summary>
	///     Initializes a new instance of the <see cref="GetCommunicationWayKeysResponse" /> class.
	/// </summary>
	/// <param name="id">
	...
	public GetCommunicationWayKeysResponse(string id = default, string objectName = default, DateTime? create = default,
	...
	public bool Equals(GetCommunicationWayKeysResponse? input)
	{
		...
		return
			...
			(
				Upadate == input.Upadate ||
				(Upadate != null &&
				 Upadate.Equals(input.Upadate))
			) &&
			(
				Name == input.Name ||
				(Name != null &&
			...
			(
				...
				(TranslationCode != null &&
				 TranslationCode.Equals(input.TranslationCode))
			);
	}
	...
	{
		return Equals(input as GetCommunicationWayKeysResponse);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (Upadate != null)
			{
				hashCode = hashCode * 59 + Upadate.GetHashCode();
			}
			...
			{
				hashCode = hashCode * 59 + TranslationCode.GetHashCode();
			}
