	...
	public ModelCheckAccountTransactionUpdateCheckAccount(int? id = default, string objectName = "CheckAccount")
	{
		...
		if (id == null)
		{
			throw new InvalidDataException(
				"id is a required property for ModelCheckAccountTransactionUpdateCheckAccount and cannot be null");
		}
		...
		{
			throw new InvalidDataException(
				"objectName is a required property for ModelCheckAccountTransactionUpdateCheckAccount and cannot be null");
		}
