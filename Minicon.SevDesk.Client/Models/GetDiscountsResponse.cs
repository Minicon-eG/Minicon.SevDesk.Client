...
public class GetDiscountsResponse : IEquatable<GetDiscountsResponse>, IValidatableObject
{
	...
	public GetDiscountsResponse(List<ModelDiscount> objects = default)
	{
		Objects = objects;
	}
	...
	/// <summary>
	///     Returns true if GetDiscountsResponse instances are equal
	/// </summary>
	...
	{
		return Equals(input as GetDiscountsResponse);
	}
