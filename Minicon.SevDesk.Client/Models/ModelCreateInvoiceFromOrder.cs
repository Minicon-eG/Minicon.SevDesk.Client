...
public class ModelCreateInvoiceFromOrder : IEquatable<ModelCreateInvoiceFromOrder>, IValidatableObject
{
		...
		decimal? amount = default, string partialType = default)
	{
		...
		if (order == null)
		{
			throw new InvalidDataException(
				"order is a required property for ModelCreateInvoiceFromOrder and cannot be null");
		}
	...
	public bool Equals(ModelCreateInvoiceFromOrder input)
	{
		...
		return
			...
			(
				PartialType == input.PartialType ||
				(PartialType != null &&
				 PartialType.Equals(input.PartialType))
			);
	}
	...
	public override string ToString()
	{
		...
		sb.Append("  PartialType: ").Append(PartialType).Append("\n");
		sb.Append("}\n");
		return sb.ToString();
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (PartialType != null)
			{
				hashCode = hashCode * 59 + PartialType.GetHashCode();
			}
